...
export const React = styled.div<Pick<StyledLoader, '$spinnerSize'>>`
  ...
  ${tw`flex justify-center content-center absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 rounded-[50%] [border-width:1.5cqmin] border-brand-react w-[73%] pt-[5%] pb-[5%]`}
  ${tw`before:box-content before:flex before:justify-center before:content-center before:content-empty before:absolute before:top-1/2 before:left-1/2 before:-translate-y-1/2 before:-translate-x-1/2 before:rotate-[57deg] before:rounded-[50%] before:[border-width:1.5cqmin] before:border-brand-react before:w-[100%] before:pb-[35.5%]`}
  ${tw`after:box-content after:flex after:justify-center after:content-center after:content-empty after:absolute after:top-1/2 after:left-1/2 after:-translate-y-1/2 after:-translate-x-1/2 after:rotate-[-57deg] after:rounded-[50%] after:[border-width:1.5cqmin] after:border-brand-react after:w-[100%] after:pb-[35.5%]`}
`

export const Nucleus = styled.div`
  ${tw`w-[20%] pb-[20%] rounded-full bg-brand-react`}
`
